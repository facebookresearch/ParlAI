...
python examples/interactive.py -mf 'data/models/personachat/seq2seq_no_dropout0.2_lstm_1024_1e-3' -m 'projects.personachat.persona_seq2seq:PersonachatSeqseqAgentBasic' --dict-file 'data/models/personachat/fulldict.dict' --interactive-mode True

...
python examples/eval_model.py -mf 'profilememory_learnreweight_sharelt_encdropout0.4_s2s_usepersona_self_useall_attn_general_lstm_1024_1_1e-3_0.1' -m 'projects.personachat.persona_seq2seq:PersonachatSeqseqAgentSplit' -t personachat:self --dict-file 'projects/personachat/fulldict.dict' -dt test --rank-candidates True

...
The particular task requires a world for the agents that handles the particular nature of the task, 
see e.g. `here <https://github.com/facebookresearch/ParlAI/blob/master/parlai/tasks/convai2/worlds.py#L98>`_ 

...
Torch Agent implement much of the boilerplate necessary for implementing
...
Torch Ranker Agent and Torch Generator more specialized stub methods, and provide

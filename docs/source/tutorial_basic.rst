...
- seamless integration of Amazon Mechanical Turk for data collection and human evaluation
    ...
    - *new:* integration with Facebook Messenger for an alternative UI for connecting agents
...
tutorial (see: `Batchign and Hogwild Tutorial <http://parl.ai/static/docs/tutorial_worlds.html>`__. ).
...
metrics such as loss or perplexity.

...
COMMAND_SEND_MESSAGE ...... / MTurk web client is expected to send a new message
...
COMMAND_CHANGE_CONVERSATION / MTurk web client should change to new conversation
COMMAND_RESTORE_STATE ..... / MTurk web client should restore the state of a
                            ...
                            \  last sent command to restore is in 'last_command'
...
COMMAND_INACTIVE_HIT ...... / MTurk web client should remove the done button and
                            |  text box and instead display the contents of
                            \  'inactive_text' param.
COMMAND_INACTIVE_DONE ..... / MTurk web client should show the "DONE" button and
                            \  display the contents of 'inactive_text' param.
"""

...
messages are in the 'messages' param, and the \\ last sent command is in 'last_command'
COMMAND_INACTIVE_HIT ...... / MTurk web client should remove the done button | and text
box and instead display the contents of \\ 'inactive_text' param. COMMAND_INACTIVE_DONE
..... / MTurk web client should show the "DONE" button |  and display the contents of \\
'inactive_text' param.
"""

...
class TestSocketManagerMessageHandling(unittest.TestCase):
    ...
    def test_alive_send_and_disconnect(self):
        ...
        self.assertEqualBy(lambda: acked_packet is None, False, 0.5)
        self.assertIsNone(incoming_hb)
        self.assertIsNone(message_packet)
        ...
        self.assertEqualBy(lambda: incoming_hb is None, False, 0.5)
        self.assertIsNone(acked_packet)
        ...
        self.assertEqualBy(lambda: self.message_packet is None, False, 0.5)
        ...
        self.assertEqualBy(lambda: message_packet is None, False, 0.5)
        ...
        self.assertEqualBy(lambda: self.dead_worker_id, TEST_WORKER_ID_1, 1)
    ...
    def test_one_agent_disconnect_other_alive(self):
        ...
        self.assertEqualBy(lambda: self.dead_worker_id, TEST_WORKER_ID_2, 1)

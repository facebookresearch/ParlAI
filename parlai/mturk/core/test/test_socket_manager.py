...
class TestSocketManagerMessageHandling(unittest.TestCase):
    ...
    def test_alive_send_and_disconnect(self):
        ...
        time.sleep(0.5)
        self.assertIsNotNone(incoming_hb)
        self.assertIsNone(acked_packet)
        ...
        time.sleep(0.5)
        self.assertIsNotNone(self.message_packet)
        self.assertIsNotNone(acked_packet)
        ...
        time.sleep(0.5)
        self.assertIsNotNone(message_packet)
        ...
        time.sleep(1)
        self.assertEqual(self.dead_worker_id, TEST_WORKER_ID_1)
        self.assertEqual(self.dead_assignment_id, TEST_ASSIGNMENT_ID_1)
        self.assertGreater(hb_count, 3)

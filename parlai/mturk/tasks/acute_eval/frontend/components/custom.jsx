                ...
                <FormGroup>
                    <Col sm={6}>
                      ...
                      {/* <Slider
                        ...
                        marks={{
                          // '-100': <div>I would <b>strongly</b> prefer to talk to <div style={speaker1_style}>Speaker 1</div></div>,
                          '-1000': '',
                          // '-90': '',
                          '-800': '',
                          // '-70': '',
                          ...
                          // '-10': '',
                          '0': '',
                          // '0': <div>I don't have a preference</div>,
                          // '10': '',
                          '200': '',
                          // '30': '',
                          '400': '',
                          ...
                          // '90': '',
                          '1000': '',
                          // '100': <div>I would <b>strongly</b> prefer to talk to <div style={speaker2_style}>Speaker 2</div></div>,
                        }}
                        ...
                        dotStyle={{
                          height: 10, width: .5, bottom: -4, borderColor: 'darkgray'}}
                        activeDotStyle={{
                          height: 10, width: .5, bottom: -4, borderColor: 'darkgray'}}
                        railStyle={{ backgroundColor: 'white' }}
                        style={{'width': '67%', 'display': 'inline-block' }}
                        value={this.state.speakerChoice}
                      ...
                      <div style={{fontSize:12}}>
                        ...
                        <Col sm={2}>
                          I would <b>strongly</b> prefer to talk to <div style={speaker1_style}>Speaker 1</div>
                        </Col>
                        <Col sm={2}>
                        </Col>
                        <Col sm={2}>
                        ...
                        <Col sm={2}>
                          I would <b>strongly</b> prefer to talk to <div style={speaker2_style}>Speaker 2</div>
                        </Col>
                        <Col sm={1}>
                        </Col>
                      </div> */}
  ...
  render () {
    ...
    let content = (
      <div>
        ...
        based on the quality of conversation only. <b>Don't base your judgement&nbsp;
        on their hobbies, job, etc.</b>&nbsp;
        Do your best to ignore the <div style={otherspeaker_style}>other speaker</div>.&nbsp;
        ...
        <b>{question}</b> You should&nbsp;
        also provide a very brief justification. Failure to do so could result&nbsp;
        in your hits being rejected.
        <br/><br/>

        <b> You will do this for {num_subtasks} pairs of conversations.&nbsp;
    ...
    if (!this.props.is_cover_page) {
      ...
      content = (
        <div>
          ...
          <div style={speaker1_style}>Speaker 1</div> on the left and&nbsp;
          <div style={speaker2_style}>Speaker 2</div> on the right&nbsp;
          based on the quality of conversation. <b>Don't base your judgement&nbsp;
          on their hobbies, job, etc. </b>&nbsp;
          Do your best to ignore the <div style={otherspeaker_style}>other speaker</div>.&nbsp;
          You may need to scroll down to see the full conversations.&nbsp;
          <br/><br/>
          ...
          <b> You will do this for {num_subtasks} pairs of conversations.&nbsp;
          After completing each judgement, use the [NEXT] button (which will appear below after you finish your judgement).</b>
          <br/>
        </div>
      );
    }

...
'response to a comment on an image.'
...
<br>
<br>
<h4><b>STEP 1</b></h4> You will be shown an image, and a comment.
Additionally, you may be shown the personality of the person who wrote the comment.
<br>
<br>
E.g., you may be shown an image of a tree, and the following discussion:
<br> 1. Comment: "What an absolutely beautiful tree! I would put this in my living room
it's so extravagant!"
<br> 2. Responses to Evaluate: (a) I bet I could climb that tree!,
(b) It's an okay tree.
<br>
<br>
...
<br>
<br>
E.g. in the example above, the first response (a) is more engaging than the second.
<br>
<br>
...
<br>
<br>
You will then write a reason indicating why you believe this comment is the
more engaging one.
<br>
E.g. in the example above, you may say "The response I chose was more lively
and entertaining."
<br>

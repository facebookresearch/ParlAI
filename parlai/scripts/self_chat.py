...
def setup_args(parser=None):
    ...
    parser.add_argument(
        '--partner-opt-file',
        default=None,
        help='Path to file containing override opts for partner (most opts will be loaded from <partner_model_file>.opt',
    )
...
def self_chat(opt):
    ...
    if not partner:
        ...
        if partner_opt_file:
            ...
            print(f"WARNING: Loading opts from {partner_opt_file}")

...
class TorchAgent(Agent):
    ...
    def add_cmdline_args(cls, argparser):
        ...
        agent.add_argument(
            '--save-history-vec', type='bool', default=True,
            help='save vectorized version of dialogue history instead of the '
                 'string version'
        )
        agent.add_argument(
    ...
    def vectorize(self, obs, add_start=True, add_end=True, truncate=None,
        ...
        if cands_key is not None and self.opt[cands_key] == 'inline':

...
class TorchAgent(Agent):
    ...
    def add_cmdline_args(cls, argparser):
        ...
        agent.add_argument(
            '-inpdrop', '--input-dropout', type=float, default=0.0,
            help='Each token from the input can be masked with UNK label with '
                 'this probability. To use this -- call self._add_input_dropout()')
        # GPU arguments
    ...
    def __init__(self, opt, shared=None):
        ...
        self.input_dropout = opt.get('input_dropout', 0.0)

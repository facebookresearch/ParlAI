  ...
  */
  ...
  makeProps() {        
    ...
    if (Object.keys(config_file).length){
      ...
      this.setState({
        noHits: calcNoHits(this.props.session.nUnit, this.props.session.nAssignment, nTotal)
      })
    }
  };
  ...
  _showGeneralConfig () {
    ...
    return (<>
      ...
      <FormItem
        ...
        rules={[{required: true, whitespace: true, message: "Please write background"}]}
        validateTrigger={['onChange', 'onBlur']}
        onChange={(e) => this.setState({generic_introduction: e.target.value})}
      >
      ...
      <FormItem
        ...
        rules={[{required: true, whitespace: true, message: "Please write instructions"}]}
        validateTrigger={['onChange', 'onBlur']}
        onChange={(e) => this.setState({generic_instructions: e.target.value})}
      >
      ...
      >
          <Switch onChange={(e) => {this.setState({enableMarkdown: e})}}/>
      </FormItem>
      ...
      <FormItem
        ...
        name='time'
        validateTrigger={['onChange', 'onBlur']}
        rules={[{required: true, whitespace: true, message: "Please fill out time in minutes"}]}
      ...
      <FormItem
        ...
        required={true}
        name='payment'
        onChange={(e) => {e.preventDefault(); this.setState({payment: parseFloat(e.target.value)})}}
        validateTrigger={['onChange', 'onBlur']}
        rules={[{required: true, whitespace: true, message: "Please fill out payment"}]}
      >
  ...
  _onChangeTaskNo = (event) => {
    ...
    this.setState({noHits: calcNoHits(tasks, this.state.nAssignment, nTotal), nUnit: tasks})
  }
  ...
  _onChangeAssignmentNo = (event) => {
    ...
    const tasks = event.target.value;
    const nTotal = (this.state[`${this.taskName}_data`] || []).length;
    this.setState({noHits: calcNoHits(this.state.nUnit, tasks, nTotal), nAssignment: tasks})
  }
    ...
    return (<>
      <div style={{"padding-left": "1%"}}>
        <FormItem
          ...
          validateTrigger={['onChange', 'onBlur']}
          rules={[{required: true, whitespace: true, message: (`Please specify the number of ${textTask}(s) in each HIT.`)}]}
        >
        ...
        <FormItem
          ...
          validateTrigger={['onChange', 'onBlur']}
          rules={[{required: true, whitespace: true, message: (`Please specify the number of annotations per ${textTask}.`)}]}
        >
            <Input.TextArea placeholder="5" style={{width: '90%', marginRight: 8}}/>
        </FormItem>
    ...
    return (<>
      ...
      <div style={{
        ...
        <FormItem
          ...
          validateTrigger={['onChange', 'onBlur']}
          rules={[{required: true, whitespace: true, pattern: new RegExp(/^[0-9]+$/), message: (`Please specify the number of duplicated ${textTask}(s) in each HIT.`)}]}
        >
            <InputNumber style={{width: '90%', marginRight: 8}} onChange={(e) => {this.setState({nUnitDuplicated: e})}}/>
      </FormItem>
      <FormItem
      {...(formItemLayout)}
          label={(
          ...
          name='nUnitGolden'
          validateTrigger={['onChange', 'onBlur']}
          rules={[{required: true, whitespace: true, pattern: new RegExp(/^[0-9]+$/), message: (`Please specify the number of ${textTask}(s) in each HIT.`)}]}
        >
            <InputNumber placeholder="0" style={{width: '90%', marginRight: 8}} onChange={(e) => {this.setState({nUnitGolden: e})}}
                         />
      </FormItem>
  ...
  _showFeedbackConfig () {
    ...
    return (<>
      ...
      <div style={{ border: "2px solid black", margin: "10px", padding: 24}} >        
        ...
        >
            <Switch onChange={(e) => {this.setState({hasFeedbackQuestion: e})}}/>
        </FormItem>
    ...
    return (<>
      ...
      <div style={{ border: "2px solid black", margin: "10px", padding: 24}} >
        ...
        <FormItem
          ...
          validateTrigger={['onChange', 'onBlur']}
          rules={[{required: true, whitespace: true, pattern: new RegExp(/^[+-]?([0-9]+\.?[0-9]*|\.[0-9]+)$/), message: (`Please specify adjustment.`)}]}
        >
            <InputNumber placeholder="0" style={{width: '10%', marginRight: 8}} onChange={(value) => this.updateByKey(
                      ['style', 'global'], {"spacing": value}
                    )}
                         />
        </FormItem>                       
  ...
  _saveAsJSON (values) {
    ...
    const keys = [
      ...
      'questionCategories', 'questionEntities', 'questionQualities', 'style', 'enableMarkdown'
    ];
    for (const key of keys) {

...
- `mephisto.blueprint.allowed_worker_qualification`: use this qualification to restrict the task to an exclusive list of workers. Not that you must first grant this qualification to the workers who are allowed to participate.

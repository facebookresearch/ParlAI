...
DPR_BERT_MODEL_PATH = '/checkpoint/kshuster/projects/wizard_2.0/dpr/checkpoint/retriever/multiset/bert-base-encoder.cp'
...
class BertConversionUtils:
    ...
    def load_bert_state(
        ...
        pretrained_dpr_path: str = DPR_BERT_MODEL_PATH,

...
class NewfacetransformerAgent(TransformerGeneratorAgent):
    @classmethod
    def add_cmdline_args(cls, argparser):
        ...
        super(NewfacetransformerAgent, cls).add_cmdline_args(argparser)
        NewfacetransformerAgent.dictionary_class().add_cmdline_args(argparser)
        return agent

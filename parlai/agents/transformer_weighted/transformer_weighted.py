...
class TransformerWeightedAgent(TransformerGeneratorAgent):

    @classmethod
    def add_cmdline_args(cls, argparser):
        """Add command-line arguments specifically for this agent."""
        agent = argparser.add_argument_group('Transformer Weighted Arguments')
#         add_common_cmdline_args(agent)
        ...
        super(TransformerWeightedAgent, cls).add_cmdline_args(argparser)
        return agent

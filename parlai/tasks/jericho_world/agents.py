...
class ActionKGTeacher(StateToKGTeacher):
    ...
    def generate_example_text_parts(self, example: Union[Dict, Message]) -> List[str]:
        ...
        # Knowledge Graph is the label generated by this class's parent (StateToKGTeacher).
        knowledge_graph = super().generate_example_label(example)
        prts.append(wrap_content(knowledge_graph, consts.KNOWLEDGE_GRAPH))

        # The observation that was resulted fromt this action: next_state observation
        prts.append(

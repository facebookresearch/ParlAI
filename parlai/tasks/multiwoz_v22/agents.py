...
class GoalAgent(MultiwozV22Parser, tod_agents.TodGoalAgent):
    pass


class ApiSchemaAgent(MultiwozV22Parser, tod_agents.TodApiSchemaAgent):
    pass
...
class UserUttAgent(MultiwozV22Parser, tod_agents.TodUserUttAgent):
    pass


class ApiCallAndSysUttAgent(MultiwozV22Parser, tod_agents.TodApiCallAndSysUttAgent):
    pass

...
class SystemTeacher(MultidogoParser, tod_teachers.SystemTeacher):
    pass


class UserSimulatorTeacher(MultidogoParser, tod_teachers.UserSimulatorTeacher):
    pass


class StandaloneApiTeacher(MultidogoParser, tod_teachers.TodStandaloneApiTeacher):
    pass


class SingleGoalAgent(MultidogoParser, tod_agents.TodSingleGoalAgent):
    pass


class GoalAgent(MultidogoParser, tod_agents.TodGoalAgent):
    pass


class ApiSchemaAgent(MultidogoParser, tod_agents.TodApiSchemaAgent):
    pass


class UserUttAgent(MultidogoParser, tod_agents.TodUserUttAgent):
    pass


class ApiCallAndSysUttAgent(MultidogoParser, tod_agents.TodApiCallAndSysUttAgent):
    pass

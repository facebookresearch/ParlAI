...
class SystemTeacher(MsrE2EParser, tod_teachers.SystemTeacher):
    pass


class UserSimulatorTeacher(MsrE2EParser, tod_teachers.UserSimulatorTeacher):
    pass


class StandaloneApiTeacher(MsrE2EParser, tod_teachers.TodStandaloneApiTeacher):
    pass


class GoalAgent(MsrE2EParser, tod_agents.TodGoalAgent):
    pass


class ApiSchemaAgent(MsrE2EParser, tod_agents.TodApiSchemaAgent):
    pass


class UserUttAgent(MsrE2EParser, tod_agents.TodUserUttAgent):
    pass


class ApiCallAndSysUttAgent(MsrE2EParser, tod_agents.TodApiCallAndSysUttAgent):
    pass

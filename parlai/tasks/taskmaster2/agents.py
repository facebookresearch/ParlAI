...
class Taskmaster2Parser(tod_agents.TodStructuredDataParser):
    ...
    def add_cmdline_args(
        ...
        parser.add_argument(
            ...
            type=bool,
            default=True,
            help="Used for figuring out difference between new Taskmaster2 and legacy Taskmaster2. model-model chats will not work with this true, since API schema agent currently expects these",
        )
...
class StandaloneApiTeacher(Taskmaster2Parser, tod_teachers.TodStandaloneApiTeacher):
    pass


class GoalAgent(Taskmaster2Parser, tod_agents.TodGoalAgent):
    pass


class ApiSchemaAgent(Taskmaster2Parser, tod_agents.TodApiSchemaAgent):
    pass


class UserUttAgent(Taskmaster2Parser, tod_agents.TodUserUttAgent):
    pass


class ApiCallAndSysUttAgent(Taskmaster2Parser, tod_agents.TodApiCallAndSysUttAgent):
    pass

...
class TestEDTeacher(unittest.TestCase):
    ...
    def test_counts(self):
        ...
        for teacher_class in [EmpatheticDialoguesTeacher]:
            parser = ParlaiParser()
            teacher_class.add_cmdline_args(parser)
            for opt, num_episodes, num_examples in opts_episodes_and_examples:
                full_opt = parser.parse_kwargs(**opt)
    ...
    def test_check_examples(self):
        ...
        for opt, example in opts_and_examples:
            parser = ParlaiParser()
            EmpatheticDialoguesTeacher.add_cmdline_args(parser)
            full_opt = parser.parse_kwargs(**opt)
        ...
        parser = ParlaiParser()
        EmotionClassificationSituationTeacher.add_cmdline_args(parser)
        for opt, example in opts_and_examples:
            full_opt = parser.parse_kwargs(**opt)

...
task_list = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Each example contains real questions that people searched for in Google, "
            "the content of the a Wikipedia article that was within the top 5 "
            "search resutls for that query, and its annotations. "
            "The annotations have the options of a long answer that is seleced from span "
            "of major content entities in the Wikipedia article (e.g., paragraphs, tables), a short "
            "answer that is selected from one or more short span of words in the article, or 'yes/no'. "
            "The existence of any of these answer formats depends on whether the main question "
            "can be answered, given the article; if not they are left empty. "
            "There are two options for presenting the Wikipedia article (as the context) in "
            "the QA task: with or without HTML tags."
        ),
        "links": {

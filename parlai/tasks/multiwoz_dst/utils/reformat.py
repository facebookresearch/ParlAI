...
class Reformat_Multiwoz(object):
    ...
    def __init__(self, data_dir):
        ...
        self.basedata_dir = os.path.join(self.data_dir, "../MULTIWOZ2.1")
        self.val_path = os.path.join(self.basedata_dir, "valListFile.json")
        self.test_path = os.path.join(self.basedata_dir, "testListFile.json")
    ...
    def reformat_from_trade_proc_to_turn(self):
        ...
        """
        self.reformat_data_path = self.reformat_data_path.replace(
            ".json", "_filtername.json"
        )
        ...
        for dial in tqdm(self.dials):
            ...
            for turn in dial["dialogue"]:
                ...
                if (
                    "restaurant name" in turn_form["slots_inf"]
                    or "attraction name" in turn_form["slots_inf"]
                    or "hotel name" in turn_form["slots_inf"]
                ):
                    self.dials_form[
...
def Parse_args():
    ...
    parser.add_argument("--reformat_data_name", default="data.json")
    ...
    parser.add_argument(
        "--data_dir",
        default="/data/home/justincho/project/ParlAI/data/multiwoz_dst/MULTIWOZ2.2+",
    )

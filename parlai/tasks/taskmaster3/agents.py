...
class Taskmaster3Parser(tod_agents.TodStructuredDataParser):
    ...
    def __init__(self, opt: Opt, shared=None):
        ...
        if shared is None:
            warn_once(
                "Taskmaster3 is a beta dataset, and format may significantly change."
            )
            build_.build(opt)
...
class SystemTeacher(Taskmaster3Parser, tod_teachers.SystemTeacher):
    pass


class UserSimulatorTeacher(Taskmaster3Parser, tod_teachers.UserSimulatorTeacher):
    pass


class StandaloneApiTeacher(Taskmaster3Parser, tod_teachers.TodStandaloneApiTeacher):
    pass


class GoalAgent(Taskmaster3Parser, tod_agents.TodGoalAgent):
    pass


class ApiSchemaAgent(Taskmaster3Parser, tod_agents.TodApiSchemaAgent):
    pass


class UserUttAgent(Taskmaster3Parser, tod_agents.TodUserUttAgent):
    pass


class ApiCallAndSysUttAgent(Taskmaster3Parser, tod_agents.TodApiCallAndSysUttAgent):
    pass
